...
export default function Hero({ heroMode, heroImages, heroTitle, heroSubtitle, heroDescription }) {
  ...
  return (
    <section id="home" ref={sectionRef} className="relative  ">
      <div className="relative w-full overflow-hidden bg-[#0a0f1a]">
        {isCarousel ? (
          <>
            {images.length > 0 && (
              <>
                ...
                <div className="relative z-10 flex min-h-[580px] flex-col justify-center px-6 sm:px-10 lg:px-14 sm:min-h-[620px] lg:min-h-[680px]">
                  <div />
                </div>
              </>
            )}
            {images.length === 0 && (
              <div className="flex min-h-[580px] flex-col items-center justify-center gap-2 text-center text-white/50 px-6 sm:min-h-[620px] lg:min-h-[680px]">
          ...
          <>
            ...
            <div className="relative z-10 flex min-h-[580px] flex-col justify-center px-6 sm:px-10 lg:px-14 py-16 sm:min-h-[620px] lg:min-h-[680px]">
              <div ref={textRef} className="max-w-2xl">
                <h1 className="text-4xl leading-tight font-extrabold text-white sm:text-5xl lg:text-6xl xl:text-7xl">
                  {displayTitle} <span className="text-brand-orange">{displaySubtitle}</span>
                </h1>
                <p className="mt-5 max-w-lg text-base text-white/80 sm:text-lg lg:text-xl">
                  {displayDescription}
                </p>
                <div className="mt-8 flex flex-wrap gap-3">
                  <a
                    href="#menu"
                    className="inline-flex items-center gap-2 rounded-full bg-brand-orange px-8 py-3.5 text-base font-bold text-white shadow-[0_0_20px_rgba(255,102,0,0.4)] transition hover:brightness-110 active:scale-[0.97]"
                  >
                    Order Now <ArrowIcon />
                  </a>
                </div>
